function [Data,han] = roms_iview(file,var,time,iindex,grd,cplot,clev)
% [data,han] = roms_iview(file,var,time,jindex,grd,[cplot],[clev])
%
...
% $Id: roms_iview.m 592 2020-12-28 21:56:28Z wilkin $
%
% See also ROMS_ZVIEW, ROMS_SVIEW, ROMS_JVIEW
