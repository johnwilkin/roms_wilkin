function [Snew,Pobj,Hobj] = roms_isosurf(file,varname,time,value,g)
% [S,P,H] = roms_isosurf(file,varname,time,value,grd)
%
% Get the depth of an isosurface of a ROMS 3-d variable
%
% Inputs:
%
